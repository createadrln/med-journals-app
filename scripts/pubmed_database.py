...
for filename in os.listdir('/app/raw_data/pubmed'):
    if filename.endswith('.json') and 'pubmed' in filename:
        with open(os.path.join('/app/raw_data/pubmed', filename), 'r') as json_file:
            ...
            final_pubmed_data = []
            for article in pubmed_data.get('PubmedArticleSet', {}).get('PubmedArticle', []):
                final_data_row = {
            ...
            with open('/app/raw_data/combined_sources_pubmed.json', 'w') as json_file:
            ...
            with open('/app/raw_data/combined_sources_pubmed.json', 'r') as json_file:
